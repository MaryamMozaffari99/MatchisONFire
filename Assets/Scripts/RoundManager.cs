...
public class RoundManager : MonoBehaviour
{
    ...
    private void WinCheck()
    {
        ...
        {
            uiMan.winText.text = "Congradualtions! You earned 3 Stars!";
        ...
        {
            uiMan.winText.text = "Congradualtions! You earned 2 Stars!";
        ...
        {
            uiMan.winText.text = "Congradualtions! You earned 1 Stars!";
        ...
        {
            uiMan.winText.text = "Oh No! No Stars For You! O-o Try Again!?";
        }
    }
}
